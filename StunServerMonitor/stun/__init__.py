...
def stun_monitor_test(sock, host, port, source_ip, source_port, send_data=""):
...
def get_ip_info(stun_host=None, source_ip="0.0.0.0", source_port=54320,
                stun_port=3478):
...
def test_get_ip_info(s, source_ip, source_port, stun_host=None, stun_port=3478):
    port = stun_port
    (buf, addr) = stun_monitor_test(s, stun_host, port, source_ip, source_port)
